...
func start(b *gotgbot.Bot, ctx *ext.Context) error {
	_, err := ctx.EffectiveMessage.Reply(b, fmt.Sprintf("Welcome %s please chose from the list of commands to get started.", ctx.EffectiveChat.FirstName), &gotgbot.SendMessageOpts{
		ParseMode: "html",
	})
	if err != nil {
...
func about_feyorra(b *gotgbot.Bot, ctx *ext.Context) error {
	...
	_, err := ctx.EffectiveMessage.Reply(b, reply_text, &gotgbot.SendMessageOpts{
		ParseMode: "HTML",
